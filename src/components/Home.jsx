...
// Wrap necessary components with `motion`
...
function FeatureCard({ icon, title, description, titleColor }) {
  return (
    <motion.div whileHover={{ y: -5 }} transition={{ duration: 0.3 }}>
      <MotionCard className="bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-700 hover:border-blue-400 transition-colors group">
        <MotionCardContent className="text-center flex flex-col items-center">
          <motion.div
...
function Testimonial({ name, feedback, animationDelay }) {
  return (
    ...
    >
      <MotionCard className="bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700 hover:border-purple-400 transition-colors">
        <MotionCardContent className="relative">
